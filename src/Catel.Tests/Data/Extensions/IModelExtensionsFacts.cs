namespace Catel.Tests.Data
{
    ...
    public class IModelExtensionsFacts
    {
        ...
        public class Plugin : ChildAwareModelBase
        {
            ...
            public static readonly PropertyData PresetsProperty = RegisterProperty(nameof(Presets), typeof(DispatcherFastObservableCollection<Preset>),
        ...
        public class PluginContainer : ChildAwareModelBase
        {
            ...
            public static readonly PropertyData PluginsProperty = RegisterProperty(nameof(Plugins), typeof(DispatcherFastObservableCollection<Plugin>),
