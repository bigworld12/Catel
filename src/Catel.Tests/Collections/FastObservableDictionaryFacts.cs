...
namespace Catel.Tests.Collections
{
    ...
    public class FastObservableDictionaryFacts
    {
        ...
        public class TheConstructor
        {
            ...
            {
                Assert.That(() => new DispatcherFastObservableDictionary<object, object>(null, null), Throws.ArgumentNullException);
            }
            ...
            public void ReturnsDefaultComparer()
            {
                ...
                var observableDictionary = new DispatcherFastObservableDictionary<int, int>()
                {
                    {
                        1, 1
                    }
            ...
            public void ReturnsCustomComparer()
            {
                ...
                var observableDictionary = new DispatcherFastObservableDictionary<string, int>(customComparer)
                {
                    {
                        "1", 1
                    }
